# Adicione o módulo test108.py criado nos desafios anteriores, uma função chamada resumo(),
# que mostre na tela algumas informações geradas pelas funções que já temos no módulo criado até aqui.

# ESSE EXERCICIO FOI FEITO COM MODULARIZAÇÃO, POREM COLOQUEI ELE AQUI SEM IMPORT
...
def resumo(preço=0, taxa_aumento=10, taxa_diminuir=5):
    ...
    print('--' * 15)
    print(f'Preço analisado: \t{moeda(preço)}')  # O \t é uma tabulação que faz uma tabela e deixa organizado ao exibir com espaçamento
